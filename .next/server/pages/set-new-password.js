...
module.exports = __webpack_require__("aR/m");
...
const SetNewPasswordSchema = yup__WEBPACK_IMPORTED_MODULE_5__["object"]().shape({
...
const SetNewPassword = ({
  ...
  const onSubmit = async (values, {
    ...
    try {
      await Object(_api__WEBPACK_IMPORTED_MODULE_6__[/* setNewPassword */ "l"])(_objectSpread(_objectSpread({}, values), {}, {
        token: token
      }));
      router.push("/login");
    } catch (response) {
...
/* harmony default export */ __webpack_exports__["default"] = (SetNewPassword);
